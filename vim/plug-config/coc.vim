...
set cmdheight=2    " more space for status messages.
set updatetime=300 " improve UX
set shortmess+=c   " see :h shortmess
set signcolumn=yes " always show signcolumn

"<TAB/S-TAB> for autocomplete
